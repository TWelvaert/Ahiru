<template>
    <nav class="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-16">
            ...
            <div class="pt-3">
                <input
                    class="border-white opacity-50 focus:border-white focus:ring-0 rounded-full bg-black text-l text-white h-10 pr-32 px-8"
                    type="text" id="search" placeholder="SEARCH FOR ARTISTS" />
            </div>

            <div class="hidden  space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <BreezeNavLink :href="route('advertisements')" :class="{ 'active': $page.url === '/advertisements' }">
                    Advertisements
                </BreezeNavLink>
                ...
                <div class="ml-3 relative">
                    <BreezeDropdown align="right" width="48">
                        <template #trigger>
                            ...
                            <span class="inline-flex rounded-md">
                                ...
                                <button type="button"
                                    ...
                                    <img class="h-7 w-7 m-1 rounded-full" src="../../assets/images/waterloop.gif"
                                        alt="">
                                    {{ user.name}}
                        ...
                        <template #content>
                            ...
                            <BreezeDropdownLink :href="route('likes')" :class="{ 'active': $page.url === '/likes' }">
                                Likes
                            </BreezeDropdownLink>
