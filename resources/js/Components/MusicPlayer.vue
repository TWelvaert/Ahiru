<template>
		...
		<audio src="./resources/assets/sounds/Melissa.mp3" id="audio"></audio>
			<div class="relative w-player flex flex-col">
				<div class="px-10 pt-10 pb-4 flex items-center z-50">
					<img src="../../assets/images/Melissa.jpg" id="songCover" class="w-24 h-24 rounded-md mr-6 border border-bg-player-light-background dark:border-cover-dark-border"/>

					<div class="flex flex-col">
						<span id="songTitle" class="font-sans text-lg font-medium leading-7 text-slate-900 dark:text-white">test</span>
						<span id="songArtist" class="font-sans text-base font-medium leading-6 text-gray-500 dark:text-gray-400">artist</span>
				...
				<div class="px-30 rounded-b-xl  flex items-center justify-around z-50 ">
					<div class="cursor-pointer" id="songSaved">
					...
					<div class="cursor-pointer w-15 h-10  border-play-pause-light-border shadow-xl flex items-center justify-center ">
						<svg id="playBtn" class="ml-[10px]" width="18" height="18" viewBox="0 0 31 37" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<svg id="pauseBtn" width="18" height="18" viewBox="0 0 24 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
	...
	// local song titles
	const songs = ['Drive', 'Melissa', 'Thread']

	// keep track of songs
	let songIndex = 1
 
	//initially load song into DOM TODO

	// loadSong(songs[songIndex])

	//update song details TODO

	// function loadSong(song) {
	// 	songTitle.innerText = song
	// 	audio.src = `../../assets/sound/${song}.mp3`
	// 	songCover.src = `../../assets/images/${song}.jpg`
	// }
