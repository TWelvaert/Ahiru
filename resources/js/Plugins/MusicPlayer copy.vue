 ...
 <div id="musicPlayer">
	...
	<div class="relative bottom-0 w-player flex flex-col">
		<div id="hide" class="px-10 pt-10 pb-4 flex items-center z-10">
			<img :src="''" id="songCover" class="w-24 h-24 rounded-md mr-6 border "/>
			...
			<div class="flex flex-col">
				...
				<span id="songTime" class="font-sans text-base font-medium leading-6 text-gray-500 dark:text-gray-400"></span>
			</div>
			<div class="text-white mx-10">
				<span name="min" @click="min">min</span>
			<input class="mx-0" type="range" orient="vertical" id="volume-slider" min="0" max="100" step="1" v-model="volume" @input="$updateMusicPlayerVolume()">
			<span name="max" @click="max">max</span>
			</div>
		</div>
		<div class="w-full flex flex-col px-10 z-50">
			<input type="range" id="song-slider" step=".1"  @input="$updateMusicPlayerTime()"/><!--  v-model="audio.currentTime" -->
		...
		<div class="px-30 rounded-b-xl  flex items-center justify-around z-50 ">
			...
			<div class="cursor-pointer w-15 h-10  border-play-pause-light-border shadow-xl flex items-center justify-center ">
				...
				<div id="musicPlayer_pauseButton" class="bg-black rounded-full p-1">
					<svg @click="$pauseMusicPlayer()" width="18" height="18" viewBox="0 0 24 36" fill="" xmlns="http://www.w3.org/2000/svg">
				...
				<div id="musicPlayer_playButton">
					<svg @click="$playMusicPlayer()"  class="ml-[10px]" width="18" height="18" viewBox="0 0 31 37" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div id="repeat" @click="$repeatMusicPlayer()">
				<svg width="18" height="18" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
