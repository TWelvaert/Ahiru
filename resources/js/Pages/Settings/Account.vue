...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="flex items-center justify-center m-10">
            <div
                class="py-12 bg-white w-full sm:max-w-md mt-6 px-6 shadow-md overflow-hidden sm:rounded-lg items-center justify-center">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="flex items-center justify-center ">

                        <img class="h-32 w-32 m-1 rounded-full shadow-2xl " src="../../../assets/images/logologo.png"
                            alt="">
                    </div>
                    <div class=" flex items-center justify-center">
                    ...
                    <form id="form1" @submit.prevent="submit_personal_info" novalidate>
                        ...
                        <div>
                            ...
                            <BreezeInput id="name" type="text" class="mt-1 block w-full" v-model="form1.display_name"
                                required autofocus autocomplete="display name" />
                            <BreezeInputError class="mt-2" :message="form1.errors.name" />
                        </div>

                        <div>
                            <BreezeLabel for="name" value="Name" />
                            <BreezeInput id="name" type="text" class="mt-1 block w-full" v-model="form1.name" required
