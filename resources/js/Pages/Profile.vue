        ...
        <div class="container mx-auto my-3 p-3">
            <div class="md:flex no-wrap md:-mx-2 ">
                ...
                <div class="w-full px-5 md:w-3/12 ">
                        ...
                        <div v-if="auth.id == user.id && auth">
                            <form @submit.prevent="submit">
                                ...
                                <Button
                                    ...
                                    name="form" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                                    Update
                                </Button>
                            </form>
                    ...
                    <div class="my-4 flex items-center space-x-3 font-semibold text-gray-900 text-xl py-1"><span
                            class="">
                        ...
                        <span class="font-monument">FOLLOWING</span>
                    </div>
                    <!-- Following card -->
                    <div
                        class="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <div class="w-full px-5 md:w-9/12 h-64">
                    ...
                    <div class="">
                        ...
                        <div class="flex items-center space-x-2 ">
                            ...
                            <span
                                class="tracking-wide font-semibold text-gray-900 text-xl p-1 font-monument">ADVERTISEMENTS</span>
                            <div v-if="auth">
                    ...
                    <div class="grid grid-cols-1 content-center gap-8 md:grid-cols-4">
                        ...
                        " v-for="collaboration in collaborations"
                            class="block p-6 max-w-sm bg-white w-72  rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 flex-shrink-0 ">
                            ...
                            <p class="font-normal text-gray-700 dark:text-gray-400 line-clamp-5">{{
