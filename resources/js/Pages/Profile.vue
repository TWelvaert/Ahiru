                    ...
                    <div
                        ...
                        <form @submit.prevent="submit">
                            <div>
                                ...
                                <TextareaVue id="bio" type="textarea" class="border border-blue-300 p-2 w-full rounded"
                                    rows="6" v-model="form.profile[0]['bio']" required />
                                <BreezeInputError class="mt-2" />
                            </div>

                            <BreezeButton name="form" class="ml-4" :class="{ 'opacity-25': form.processing }"
                ...
                <div class="w-full m-3 md:w-9/12 h-64">
                    ...
                    <div class="">
                        ...
                        <div class="flex items-center space-x-2 ">
                            ...
                            <div v-if="auth">
                                <div v-if="auth.id == user.id">
                                    <a class="p-1 m-1 bg-green-500 py-1 px-2 rounded text-white text-sm" v-bind:href="
